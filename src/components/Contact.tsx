      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <AnimatedSection delay={0.15}>
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-accent/30 text-accent hover:bg-accent/10 transition-all duration-200 font-medium text-sm"
          >
            <Mail size={16} />
