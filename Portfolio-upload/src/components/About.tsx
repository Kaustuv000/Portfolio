...
const skills = {
  Languages: ["Python", "C", "C++", "Golang", "SQL", "Bash", "JavaScript"],
  "Tools & DevOps": ["Git", "Docker", "Linux", "CI/CD", "GCP", "JIRA", "PagerDuty", "QEMU"],
        ...
        <div className="grid md:grid-cols-5 gap-12">
          <AnimatedSection className="md:col-span-3" delay={0.1}>
            <div className="space-y-4 text-muted leading-relaxed">
              ...
              <p>
                At Warner Bros. Discovery, I engineer cloud compute
                infrastructure and data pipelines — cutting pipeline runtimes by
                75% and deploying production features across major microservices.
                I thrive at the intersection of backend systems, DevOps, and
                data engineering.
              </p>
              <p>
